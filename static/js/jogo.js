...
// Funções para reiniciar o desenho do boneco
function resetarBoneco() {
  // Aqui deve estar a lógica para resetar o desenho do boneco
}
...
function iniciarJogo() {
  ...
  atualizarDisplayDoJogo(); // Atualiza a exibição imediatamente
}
...
function atualizarDisplayDoJogo() {
  ...
  document.getElementById("dica").textContent = `Dica: ${dicaAtual}`; // Dica exibida imediatamente
...
// Adiciona o evento para iniciar o jogo quando a página carrega
